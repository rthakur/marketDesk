 ...
 <div class="row">
  <div class="col-sm-6 col-sm-offset-2">
        ...
        <form class="form-horizontal" method="post" action="/portfolio">
          ...
          <div class="form-group">
            <label class="control-label col-sm-3">Avg. cost Price:</label>
            <div class="col-sm-9" >
          ...
          <div class="form-group">
            <label class="control-label col-sm-3" for="pwd">Loss Exit Price:</label>
            <div class="col-sm-9" >
              <input type="number" class="form-control" name="exit" step=any>
            </div>
          </div>
          <div class="form-group">
